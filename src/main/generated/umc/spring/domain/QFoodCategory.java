...
public class QFoodCategory extends EntityPathBase<FoodCategory> {
    ...
    public final ListPath<Market, QMarket> marketList = this.<Market, QMarket>createList("marketList", Market.class, QMarket.class, PathInits.DIRECT2);

    public final EnumPath<umc.spring.domain.enums.FoodCategory> name = createEnum("name", umc.spring.domain.enums.FoodCategory.class);
