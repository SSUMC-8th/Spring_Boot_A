...
public class QMember extends EntityPathBase<Member> {
    ...
    public final SetPath<FavoredFood, QFavoredFood> favoredFoods = this.<FavoredFood, QFavoredFood>createSet("favoredFoods", FavoredFood.class, QFavoredFood.class, PathInits.DIRECT2);
