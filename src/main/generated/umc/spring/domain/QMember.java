...
public class QMember extends EntityPathBase<Member> {
    ...
    public final ListPath<umc.spring.domain.mapping.Agreement, umc.spring.domain.mapping.QAgreement> AgreeList = this.<umc.spring.domain.mapping.Agreement, umc.spring.domain.mapping.QAgreement>createList("AgreeList", umc.spring.domain.mapping.Agreement.class, umc.spring.domain.mapping.QAgreement.class, PathInits.DIRECT2);
    ...
    public final BooleanPath over14 = createBoolean("over14");
