...
public class QTerm extends EntityPathBase<Term> {
    ...
    public final ListPath<umc.spring.domain.mapping.Agreement, umc.spring.domain.mapping.QAgreement> memberAgreeList = this.<umc.spring.domain.mapping.Agreement, umc.spring.domain.mapping.QAgreement>createList("memberAgreeList", umc.spring.domain.mapping.Agreement.class, umc.spring.domain.mapping.QAgreement.class, PathInits.DIRECT2);
