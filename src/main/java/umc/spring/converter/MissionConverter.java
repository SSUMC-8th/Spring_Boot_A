...
public class MissionConverter {
    ...
    public static MissionResponseDTO.marketMissionDTO toMarketMission(Mission mission){
        return MissionResponseDTO.marketMissionDTO.builder()
    ...
    public static MissionResponseDTO.marketMissionListDTO toMarketMissionListDTO(Page<Mission> missionList){
        List<MissionResponseDTO.marketMissionDTO> marketMissionDTOList = missionList.stream()
                .map(MissionConverter::toMarketMission).collect(Collectors.toList());

        return MissionResponseDTO.marketMissionListDTO.builder()
                .isLast(missionList.isLast())
                .isFirst(missionList.isFirst())
                .totalPage(missionList.getTotalPages())
                .totalElements(missionList.getTotalElements())
                .listSize(marketMissionDTOList.size())
                .missionList(marketMissionDTOList)
                .build();
    }
}
